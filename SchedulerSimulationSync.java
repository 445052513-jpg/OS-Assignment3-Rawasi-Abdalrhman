...
class SharedResources {
    ...
    // Added lock for protecting shared resources
    ...
    // Added semaphore to control CPU access (1 process at a time)
    ...
    public static void incrementCompletedProcess() {
        // TODO: Protect this critical section with a lock
        //added sysnchronization for completedProcessCount
            lock.lock();
    try {
    ...
    public static void addWaitingTime(long time) {
        // TODO: Protect this critical section with a lock
        //added sysnchronization for totalWaitingTime
            lock.lock();
    try {
    ...
    public static void logExecution(String message) {
        ...
        //added sysnchronization for executionLog
        lock.lock();
    try {
    ...
    public void run() {
       ...
       try {
        ...
        try {
            ...
            //Release CPU access after exeution
